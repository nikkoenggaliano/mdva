...
import { AppBar, Toolbar, IconButton, Typography, Drawer, List, ListItem, ListItemText, Box, Button, Container, useTheme, Tooltip, useMediaQuery, ListItemIcon } from '@mui/material'
...
export default function UserLayout() {
  ...
  const menu = [
    ...
    { to: '/inventory-requests', label: 'Inventory Requests', icon: <ListAltIcon /> },
    { to: '/leave', label: 'Leave Request', icon: <AssignmentIcon /> },
